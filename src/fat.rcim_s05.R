...
save(list = c(ls(pattern = 'all.tf'),'rcim.tf.ss.s05'), file = "rcim/tf_s0.5_w1_w0.5_w0.25.rda")
...
save(list = c(ls(pattern = 'all.gfp'),'rcim.gfp.ss.s05'), file = "rcim/gfp_s0.5_w1_w0.5_w0.25.rda")
...
save(list = c(ls(pattern = 'all.rfp'),'rcim.rfp.ss.s05'), file = "rcim/rfp_s0.5_w1_w0.5_w0.25.rda")
...
save(list = c(ls(pattern = 'all.ffp'),'rcim.ffp.ss.s05'), file = "rcim/ffp_s0.5_w1_w0.5_w0.25.rda")
...
save(list = c(ls(pattern = 'all.mfp'),'rcim.mfp.ss.s05'), file = "rcim/mfp_s0.5_w1_w0.5_w0.25.rda")
